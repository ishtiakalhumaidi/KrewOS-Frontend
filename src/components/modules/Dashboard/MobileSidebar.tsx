  ...
  return (
    <Sheet>
      <SheetTrigger asChild>
        {/* This is the Hamburger Button that will show on mobile */}
      ...
      <SheetContent side="left" className="w-72 p-0 flex flex-col bg-white dark:bg-zinc-900 border-r-zinc-200 dark:border-r-zinc-800">
        <VisuallyHidden>
